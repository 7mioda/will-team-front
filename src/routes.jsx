...
const AppRouter = ({ isAdmin }) => (
  <BrowserRouter>
    <Switch>
      ...
      <Route
        path="/team-will-bank/my-space/credit-details/:creditId"
        component={Header}
      />
      <Route
        path="/team-will-bank/my-space/credits-proposals"
        component={CreditsList}
      />
      <Route
        path="/team-will-bank/my-space/submit-credit-proposal/:creditId"
        component={CreditProposal}
      />
      <Route
        path="/team-will-bank/my-space/credit-proposal/:creditId"
        component={CreditProposal}
      />
      <Route
        path="/team-will-bank/my-space/update-credit/:creditId"
        component={CreditsList}
      />
      /* --------------------- ADMIN ----------------------------*/
